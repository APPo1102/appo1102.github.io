"use strict";
(self.webpackChunklegion_solver = self.webpackChunklegion_solver || []).push([[792], {
    365: (e, t, i) => {
        i.d(t, {
            A: () => o
        });
    ...
    616: (e, t, i) => {
        ...
        }(a = "curId"))in l ? Object.defineProperty(l, a, {
            value: 1,
            enumerable: !0,
            configurable: !0,
            writable: !0
        ...
        function() {
            for (let e = 0; e < k.length / 4; e++)
                for (let t = e; t < k.length / 2; t++)
                    A[0].push(new s(t,e)),
                    A[1].push(new s(e,t + 1)),
                    A[2].push(new s(e,k[0].length - 2 - t)),
                    A[3].push(new s(t,k[0].length - 1 - e)),
                    A[4].push(new s(k.length - 1 - t,k[0].length - 1 - e)),
                    A[5].push(new s(k.length - 1 - e,k[0].length - 2 - t)),
                    A[6].push(new s(k.length - 1 - e,t + 1)),
                    A[7].push(new s(k.length - 1 - t,e));
            for (let e = k.length / 4; e < k.length / 2; e++)
                for (let t = e; t < k.length / 2; t++)
                    A[8].push(new s(t,e)),
                    A[9].push(new s(e,t + 1)),
                    A[10].push(new s(3 * k.length / 4 - 1 - t,k.length / 4 + 1 + e)),
                    A[11].push(new s(t,k[0].length - 1 - e)),
                    A[12].push(new s(k.length - 1 - t,k[0].length - 1 - e)),
                    A[13].push(new s(t + k.length / 4,e + k.length / 4 + 1)),
                    A[14].push(new s(t + k.length / 4,3 * k.length / 4 - e)),
                    A[15].push(new s(k.length - t - 1,e))
        }();
        let $ = 0;
        localStorage.getItem("boardFilled") && ($ = JSON.parse(localStorage.getItem("boardFilled")),
        document.getElementById("boardFilledValue").innerText = `${$}`);
        let J = !1;
        localStorage.getItem("isBigClick") && (document.getElementById("bigClick").checked = JSON.parse(localStorage.getItem("isBigClick")),
        JSON.parse(localStorage.getItem("isBigClick")) && Z());
        let j = !1;
        ...
        document.getElementById("bigClick").addEventListener("click", Z),
        ...
        document.getElementById("clearBoard").addEventListener("click", (function() {
            for (let e = 0; e < k.length; e++)
                for (let t = 0; t < k[0].length; t++)
                    k[e][t] = -1,
                    H(e, t).style.background = I.get(k[e][t]);
            $ = 0,
        ...
        document.getElementById("darkMode").addEventListener("click", Y);
        let R, V = !1;
        for (let e = 0; e < k.length; e++)
            for (let t = 0; t < k[0].length; t++) {
                let i = H(e, t);
        ...
        function q() {
            for (let e = 0; e < k.length; e++)
                for (let t = 0; t < k[0].length; t++)
                    H(e, t).style.borderWidth = "1px";
            for (let e = 0; e < k[0].length / 2; e++)
                H(e, e).style.borderTopWidth = "3px",
                H(e, e).style.borderRightWidth = "3px",
                H(k.length - e - 1, e).style.borderBottomWidth = "3px",
                H(k.length - e - 1, e).style.borderRightWidth = "3px",
                H(e, k[0].length - e - 1).style.borderTopWidth = "3px",
                H(e, k[0].length - e - 1).style.borderLeftWidth = "3px",
                H(k.length - e - 1, k[0].length - e - 1).style.borderBottomWidth = "3px",
                H(k.length - e - 1, k[0].length - e - 1).style.borderLeftWidth = "3px";
            for (let e = 0; e < k.length; e++)
                H(e, 0).style.borderLeftWidth = "3px",
                H(e, k[0].length / 2).style.borderLeftWidth = "3px",
                H(e, k[0].length - 1).style.borderRightWidth = "3px";
            for (let e = 0; e < k[0].length; e++)
                H(0, e).style.borderTopWidth = "3px",
                H(k.length / 2, e).style.borderTopWidth = "3px",
                H(k.length - 1, e).style.borderBottomWidth = "3px";
            for (let e = k.length / 4; e < 3 * k.length / 4; e++)
                H(e, Math.floor(k[0].length / 4)).style.borderLeftWidth = "3px",
                H(e, Math.floor(3 * k[0].length / 4)).style.borderRightWidth = "3px";
            for (let e = Math.ceil(k[0].length / 4); e < Math.floor(3 * k[0].length / 4); e++)
                H(k.length / 4, e).style.borderTopWidth = "3px",
                H(3 * k.length / 4, e).style.borderTopWidth = "3px"
        }
        ...
        function K(e, t, i) {
            if (O == F) {
                if (J)
                    if (0 == i)
                        for (let i of A[z(e, t)])
                            H(i.x, i.y).style.background = I.get(0),
                            -1 == k[i.x][i.y] && $++,
                            k[i.x][i.y] = 0;
                    else
                        for (let i of A[z(e, t)])
                            H(i.x, i.y).style.background = I.get(-1),
                            0 == k[i.x][i.y] && $--,
                            k[i.x][i.y] = -1;
                else {
                    let n = H(e, t);
                ...
                localStorage.setItem("legionBoard", JSON.stringify(k)),
                localStorage.setItem("boardFilled", JSON.stringify($)),
                document.getElementById("boardFilledValue").innerText = `${$}`
            }
        }
        function U(e, t) {
            if (O == F)
                if (J)
                    for (let i of A[z(e, t)])
                        -1 == k[i.x][i.y] ? H(i.x, i.y).style.background = G ? "dimgrey" : "silver" : H(i.x, i.y).style.background = G ? "rgb(20, 20, 20)" : "dimgrey";
                else
                    -1 == k[e][t] ? H(e, t).style.background = G ? "dimgrey" : "silver" : H(e, t).style.background = G ? "rgb(20, 20, 20)" : "dimgrey"
        }
        function X(e, t) {
            if (O == F)
                if (J)
                    for (let i of A[z(e, t)])
                        -1 == k[i.x][i.y] ? H(i.x, i.y).style.background = I.get(-1) : H(i.x, i.y).style.background = I.get(0);
                else
                    -1 == k[e][t] ? H(e, t).style.background = I.get(-1) : H(e, t).style.background = I.get(0)
        }
        function Q() {
            q(),
            function() {
                ...
                for (let t = 0; t < k.length; t++)
                    for (let i = 0; i < k[0].length; i++)
                        e = k[t][i],
                        H(t, i).style.background = I.get(e);
                0 == N.length && P[0] && (N = P[0].history);
                for (let e of N)
                    for (let t = 0; t < e.length; t++) {
                        k[e[t].y][e[t].x - 1] > 0 && ("3px" == H(e[t].y, e[t].x).style.borderLeftWidth || "3px" == H(e[t].y, e[t].x - 1).style.borderRightWidth) && (H(e[t].y, e[t].x).style.borderLeftWidth = "1px",
                        H(e[t].y, e[t].x - 1).style.borderRightWidth = "1px"),
                        k[e[t].y - 1] && k[e[t].y - 1][e[t].x] > 0 && ("3px" == H(e[t].y, e[t].x).style.borderTopWidth || "3px" == H(e[t].y - 1, e[t].x).style.borderBottomWidth) && (H(e[t].y, e[t].x).style.borderTopWidth = "1px",
                        H(e[t].y - 1, e[t].x).style.borderBottomWidth = "1px");
                        for (let i = 0; i < e.length; i++)
                            t != i && e[t].x - 1 == e[i].x && e[t].y == e[i].y && (H(e[t].y, e[t].x).style.borderLeftWidth = "0px",
                            k[0][e[t].x - 1] && (H(e[t].y, e[t].x - 1).style.borderRightWidth = "0px")),
                            t != i && e[t].x == e[i].x && e[t].y - 1 == e[i].y && (H(e[t].y, e[t].x).style.borderTopWidth = "0px",
                            k[e[t].y - 1] && (H(e[t].y - 1, e[t].x).style.borderBottomWidth = "0px"))
                    }
            }()
        }
        function Y() {
                ...
                for (let e = 0; e < P.length; e++)
                    for (let t = 0; t < P[e].board.length; t++)
                        for (let i = 0; i < P[e].board[0].length; i++)
                            0 == e ? (H(t, i).style.borderWidth = "1px",
                            P[e].board[t][i] >= 0 && (H(t, i).style.background = I.get(0),
        ...
        JSON.parse(localStorage.getItem("isDarkMode")) && Y())
    }
}, e => {
    e.O(0, [502], ( () => e(e.s = 616))),
    e.O()
